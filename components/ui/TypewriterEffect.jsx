...
// Classic Typewriter Effect (with animation for each character)
  ...
  return (
    <div className={cn("text-base sm:text-xl md:text-3xl lg:text-5xl font-bold text-center", className)}>
      ...
      <motion.span
        ...
        className={cn("inline-block rounded-sm w-[4px] h-4 md:h-6 lg:h-10 bg-green-600", cursorClassName)}
      />
    </div>
  );
};

// Smooth Typewriter Effect (without visible character by character typing)
